...
export default async function ChatListPage({ searchParams }: PageProps) {
  ...
  return (
    <div className="flex-1 overflow-y-auto p-6 max-w-3xl mx-auto w-full animate-enter">
        ...
        <div className="bg-[#FF471A1A] border border-[#FF471A33] rounded-2xl p-4 mb-5 flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-text-secondary text-xs mt-0.5">
              El plan Free permite hasta {FREE_CHAT_LIMIT} chats guardados.{' '}
          ...
          <div className="flex-1 min-w-0">
            ...
            {messagesLeft === 0 && (
              <p className="text-[#FF471A] text-xs mt-1.5 font-medium">
                Límite diario alcanzado — se renueva mañana a las 00:00 UTC
              </p>
            )}
          </div>
          <Link
      ...
      {isFree && chats.length > 0 && (
        <p className="text-center text-text-muted text-xs mt-6">
          Plan Free: {chatCount} / {FREE_CHAT_LIMIT} chats guardados.{' '}
