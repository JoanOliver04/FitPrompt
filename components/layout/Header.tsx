...
export default function Header({ onMenuClick }: Props) {
  ...
  return (
    <header className="h-14 shrink-0 flex items-center gap-3 px-4 bg-[#1a1a1a]/80 backdrop-blur-sm border-b border-[#2a2a2a] z-30">
      <button
        type="button"
        onClick={onMenuClick}
        className="w-9 h-9 flex items-center justify-center rounded-xl text-[#999] hover:text-white hover:bg-[#242424] transition-all active:scale-95"
