...
export default function Header({ onMenuClick }: Props) {
  ...
  return (
    <header className="h-14 shrink-0 flex items-center gap-3 px-4 bg-[var(--bg-glass)] backdrop-blur-sm border-b border-border-default z-30 transition-colors duration-300">
      <button
        type="button"
        onClick={onMenuClick}
        className="w-9 h-9 flex items-center justify-center rounded-xl text-text-subtle hover:text-text-primary hover:bg-bg-tertiary transition-all active:scale-95"
